 ...
 */
	Configure::write('Security.salt', 'ASjduqwidhyasdnIASDqwegtbjsbnb8487');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7005487866214756487');
...
Configure::write('Config.language', 'es-ve');
